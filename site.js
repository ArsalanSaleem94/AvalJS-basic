//jQuery(document).ready(function ($) {
    ...
    $('body').on('click', function (e) {
        ...
        // if($(e.target).closest('#pagos-card-pop1').length == 0 && $(e.target).closest('.pagos-bottom-button').length !=z= 0) {
        //     console.log('sadhasd')
        // }
    ...
    $(".cuenta-card-button").click(function () {
        $(".cuenta-pop3").show();
        $(".actividad-black2").show();
        $("body").css("overflow", "auto");
    });
    ...
    $(".description-td").click(function () {
        $(".description-td .fa-commenting").toggle();
        $(".description-td .buzon-td-text").toggleClass("buzon-td-text-toggle");
    });
    ...
    $(".buzon-text-right").click(function () {
    ...
    //landing-merchant
    // $(".landing_m-button").click(function(){
    ...
    // $(".actividad-black1").click(function() {
    //     $(".actividad-black1").hide();
    //     $(".small-menu").hide();
    //     $("body").css("overflow", "scroll")
    // });
    ...
    //$('.mail-login button').click(function () {
